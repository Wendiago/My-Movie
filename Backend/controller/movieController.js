  ...
  getDetailMovieById: catchAsync(async (req, res, next) => {
    try {
      ...
      if (refreshToken) {
        ...
        const [favoriteListData, watchingListData, ratingListData] = await Promise.all([
        ...
        response.data = { ...data.toObject(), isFavorite: !!isFavorite, isWatching: !!isWatching, rating: rating };
      }
